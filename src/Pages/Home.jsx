        ...
        <div class="px-3 py-3 lg:px-5 lg:pl-3">
          <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">
              <Link to={"/dashboard"} class="flex gap-2 items-center ms-2 md:me-24">
        ...
        <div class="h-full px-3 pb-4 overflow-y-auto bg-gray-900 dark:bg-gray-800">
          <ul class="space-y-2 font-medium">
            <li>
              <Link
                to={"/dashboard"}
                class="flex items-center p-2 text-gray-100 rounded-lg   hover:bg-gray-100  hover:text-gray-700 group"
              >
                <svg
                  class="w-5 h-5 text-gray-100 transition duration-75  group-hover:text-gray-900 "
                  aria-hidden="true"
            ...
            <li>
              <Link
                to={{ pathname: "/dashboard", search: `?admin=users` }}
                class="flex items-center p-2 text-gray-100 rounded-lg dark:text-white hover:bg-gray-100 hover:text-gray-700 group"
              >
                <svg
                  class="w-5 h-5 text-gray-100 transition duration-75  group-hover:text-gray-900 "
                  aria-hidden="true"
            ...
            <li>
              <Link
                to={{ pathname: "/dashboard", search: `?admin=withdrawal` }}
                class="flex items-center p-2 text-gray-100 rounded-lg dark:text-white hover:bg-gray-100 hover:text-gray-700 group"
              >
                <svg
                  class="w-5 h-5 text-gray-100 transition duration-75  group-hover:text-gray-900 "
            ...
            <li>
              <Link
                to={{ pathname: "/dashboard", search: `?admin=games-control` }}
                class="flex items-center p-2 text-gray-100 rounded-lg dark:text-white hover:bg-gray-100 hover:text-gray-700 group"
              >
                <svg
                  class="w-5 h-5 text-gray-100 transition duration-75  group-hover:text-gray-900 "
            ...
            <li>
              <Link
                to={{ pathname: "/dashboard", search: `?admin=matches` }}
                class="flex items-center p-2 text-gray-100 rounded-lg dark:text-white hover:bg-gray-100 hover:text-gray-700 group"
              >
                <svg
                  class="w-5 h-5 text-gray-100 transition duration-75  group-hover:text-gray-900 "
